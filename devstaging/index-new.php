...
else
{
	...
	echo '				</li><div id="fbside-bar"><li>The web is better with friends.<div id="fb-root"></div><script src="http://connect.facebook.net/en_US/all.js
	#appId=173272682690513&amp;xfbml=1"></script><fb:facepile width="180"></fb:facepile><div class="fbfriends"><a href="http://www.connichiwah.com/member/Registration.php?action=0" class="button">Find More Friends</a></div></li></div></div><div class="main-content">';
