...
$user = new flexibleAccess();
	...
	$interests = HelpingDBMethods::GetInterestsAll($userNum);
	...
	echo '	<head>';
	echo '		<title>Topics '.$name.' is interested in | kahub </title>';
	...
	echo '</div>';
		...
		if($interests!=""){
		    echo '<div id="interestsHeader">'.$name.' is interested in...</div>';
		...
		echo '<a class="unfollow" onClick="unfollowHub('.$unfollowID.')">'.$unfollowText.'</a>';
