	...
	class Login
	{
			...
			if($DBConnection)
			{
				...
				if($db_selected)
				{
					if (isset($_POST['btnLogin'])) 
					{
						...
						elseif($password == "")
						{
							$GLOBALS['errorMessage'] = "Password Required";
							Login::SetPageContents($un);
						}
						else
						{
		...
		function SetPageContents($un = '', $password = '', $rFN = '', $rLN = '', $rEmail = '', $rCEmail = '', $rDOB = '', $sex = '')
		{
			...
			$GLOBALS['LiteralContent'] = <<<Page
				...
				<div class="form-head">
				<div class="header"><div id="head-text">Login.</div></div>
			  <div class="page"><div class="login-logo"><p>No account? No problem. <br><a href="/">Sign up here!</a><br><a href="/resetpass.php">Trouble logging in?</a></p></div><li class="error">{$GLOBALS['errorMessage']}</li><li><p>
			  ...
			  <li>  <p>
			    ...
			    <li>
			      <button type = "submit" class="large orange button form-head-btn" name = "btnLogin">Login!</button>
			      </li></form></div>
