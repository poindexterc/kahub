...
<script>
  FB.init({
	...
	var publish = {
	  ...
	  message: '{$title}',
	  link: '{$sURL}',
	  picture: 'http://www.kahub.com/images/kahublogosmallfb.png',
	  actions: [
	    { name: 'Read Story', link: '{$sURL}' }
	  ],
	  user_message_prompt: 'What do you think about {$title}?'
	};
	</script>
 
<div class="container">
 	<div class="restateHead"><img src="http://kahub.com/images/kahublogosmallfb.png"> kahub Promote<div class="instructions">Select where you want to share</div></div>
	<ul class="shareTypes">
		...
		<script type="text/javascript">
		  ...
		  twttr.anywhere(function (T) {
		    ...
		    T("#tbox").tweetBox({
		      height: 100,
		      width: 400,
		      defaultContent: "{$title} {$sURL} via @kahubapp"
		    });
		...
		<div class="tumblrBox">
		<iframe src="http://www.tumblr.com/share/link?url={$eURL}&name={$title}&description={$title}" frameborder="0" width="500px" height="500px"></iframe>
        </div>
	</ul>
</div> 
