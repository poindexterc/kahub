...
$comment = HelpingMethods::GetLimitedText($_GET['c'], 70);
$fcomment = $_GET['c'];
if($_GET['cID']!=""){
    $commentData = HelpingDBMethods::GetCommentData($_GET['cID']);
...
$sTitle = HelpingMethods::GetLimitedText($title, 40);
...
<div class="container">
	...
	<ul class="shareTypes">
		...
		<script type="text/javascript">
		  ...
		  twttr.anywhere(function (T) {
		    ...
		    T("#tbox").tweetBox({
		      height: 100,
		      width: 400,
		      defaultContent: "\"{$comment}\" {$title} {$sURL} "
		    });
		...
		<div class="tumblrBox">
		<iframe src="http://www.tumblr.com/share/link?url={$eURL}&name={$title}&description={$fcomment}" frameborder="0" width="500px" height="500px"></iframe>
        </div>
	</ul>
</div> 
