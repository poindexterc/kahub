...
else
{
	...
	$featured = HelpingDBMethods::GetBadgesFeatured($userNum, "profile", 1,0);
	...
	$badges = HelpingDBMethods::GetBadgesProfile($currUser, $userNum, "profilebadge", 14, 0);
	...
	echo '	<head>';
	echo '		<title>kahub | '.$fname.'\'s Badges</title>';
	...
	echo '				<div class="main-content"><div class="profile-pic"><a href="http://www.connichiwah.com/member/profile.php?user='.$userNum.'"><img alt="" src="'.$memberImage.'" height = "156px" /></div>';
	...
	if ($friend!=true){
		...
		echo '</div> <div class="featuredbadge">'.$featured.'</div><div class="profile-badges-main"><div class="profile-badges-title">'.$first.' has earned <span class="nobadges">'.$noBadges.'</span> badges';
		echo '</div><ul id="badgesprof">';
		echo $badges;
		echo '</ul>';
