...
$user = new flexibleAccess();
	...
	$noFriends = HelpingDBMethods::GetNoOfFriends($hubData['h-hubID']);

	$interests = HelpingDBMethods::GetFollowersNoNameAll($hubData['h-hubID']);
	...
	echo '</div>';
		...
		if($interests!=""){
		    echo '<div id="friendsShow">'.$name.' has '.$noFriends.' followers</div>';
