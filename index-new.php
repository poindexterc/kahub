...
<html>
  ...
  <body onLoad="$('#video').hide();">
    ...
    <div class="header"><div class="plane"></div><div class="login"><a class="large dblue button" href="/login.php">Login</a></div><div class="topWrap" id="topWrap"><div class="logo"></div><div class="readDiscover">Read <b>news</b> with friends. Discover <b>news</b> with the world.</div><div class="descrip">kahub is a <b>news source</b> which allows you and <b>your friends</b> to have interesting, meaningful discussions about the topics that interest you most. <b>It's what's new and hot among your friends.</b></div></div><div class="signup" id="signup">
		 <li>
          		<div id="fb-root"></div><script src="http://connect.facebook.net/en_US/all.js#appId=146470212065341&amp;xfbml=1"></script><fb:login-button show-faces="true" width="700" max-rows="1" perms="email,offline_access,publish_stream"></fb:login-button>
	...
	<div class="footer">
		<div id="footerTop"><a href="http://blog.kahub.com">Blog</a> &#183; <a href="http://www.twitter.com/kahubapp" target="_blank">Twitter</a> &#183; <a href="https://www.facebook.com/pages/Kahub/212752502077574" target="_blank">Facebook</a> &#183; <a href="/privacy">Privacy</a> &#183; <a href="/terms">Terms</a></div>
