(function( $myjquery ){
    ...
    var m = {
        ...
        upload: function(file, area){
            ...
            xhr.addEventListener("load", function (e) {
                ...
                .append($myjquery('<img>',{'src': r.path + r.filename + '?' + Math.random()}));
    ...
    $myjquery.fn.droparea = function(o) {
        // Settings
        s = {
            'init': m.init,
            'start': m.start,
        ...
        this.each(function(){
            if(o) $myjquery.extend(s, o);
            var instructions = $myjquery('<div>').appendTo($myjquery(this));
            s.init($myjquery(this));            
            if(!$myjquery(this).data('value'))
            ...
            this.addEventListener("drop", function (e) {
                e.preventDefault();
                s.start($myjquery(this));
                m.traverse(e.dataTransfer.files, $myjquery(this));
                instructions.removeClass().empty();
            },false);
        });
    };
